...
exports.up = pgm => {
  ...
  pgm.addConstraint('songs', 'fk_songs.owner_user.id', 'FOREIGN KEY(owner) REFERENCES users(id) ON DELETE CASCADE')
}

exports.down = pgm => {
  // menghapus constraint fk_songa.owner_users.id pada tabel songs
